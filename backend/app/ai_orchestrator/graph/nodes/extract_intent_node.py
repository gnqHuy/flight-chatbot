...
2. 'compare_flights': Comparing prices, duration, or airlines between different flight options.
...
- GROUP FLIGHT INFO: All flight-related parameters (origin, destination, date, airline preferences, filters) MUST be grouped into a SINGLE 'search_flight' or 'compare_flights' task.
    ...
    try:
        ...
        if result and result.tasks:
            for task in result.tasks:
                ...
                flight_intents = ["search_flight", "compare_flights", "provide_info", "price_analysis"]
                ...
                if intent_str in flight_intents and task.parameters:
                    ...
                    search_params = [
                        ...
                        "travelClass", "maxPrice", "comparison_target", "start_hour", "end_hour" 
                    ]
